...
if("TRUE" STREQUAL "TRUE")
  set(ca_driver_SOURCE_PREFIX /home/nvidia/catkin_ws_/src/create_autonomy/ca_driver)
  set(ca_driver_DEVEL_PREFIX /home/nvidia/catkin_ws_/devel)
  ...
  set(ca_driver_INSTALL_PREFIX /home/nvidia/catkin_ws_/install)
...
if(NOT "/home/nvidia/catkin_ws_/src/create_autonomy/ca_driver/include;/opt/ros/kinetic/include;/usr/include " STREQUAL " ")
  set(ca_driver_INCLUDE_DIRS "")
  set(_include_dirs "/home/nvidia/catkin_ws_/src/create_autonomy/ca_driver/include;/opt/ros/kinetic/include;/usr/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'ca_driver' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/nvidia/catkin_ws_/src/create_autonomy/ca_driver/${idir}'.  ${_report}")
    endif()
    _list_append_unique(ca_driver_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "/opt/ros/kinetic/lib/libcreate.so;/usr/lib/aarch64-linux-gnu/libboost_system.so;/usr/lib/aarch64-linux-gnu/libboost_thread.so;/usr/lib/aarch64-linux-gnu/libboost_chrono.so;/usr/lib/aarch64-linux-gnu/libboost_date_time.so;/usr/lib/aarch64-linux-gnu/libboost_atomic.so;/usr/lib/aarch64-linux-gnu/libpthread.so")
