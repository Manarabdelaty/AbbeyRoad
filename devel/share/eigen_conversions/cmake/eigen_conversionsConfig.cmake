...
if("TRUE" STREQUAL "TRUE")
  set(eigen_conversions_SOURCE_PREFIX /home/nvidia/catkin_ws_/src/geometry/eigen_conversions)
  set(eigen_conversions_DEVEL_PREFIX /home/nvidia/catkin_ws_/devel)
  ...
  set(eigen_conversions_INSTALL_PREFIX /home/nvidia/catkin_ws_/install)
...
if(NOT "/home/nvidia/catkin_ws_/src/geometry/eigen_conversions/include;/usr/include/eigen3;/opt/ros/kinetic/include " STREQUAL " ")
  set(eigen_conversions_INCLUDE_DIRS "")
  set(_include_dirs "/home/nvidia/catkin_ws_/src/geometry/eigen_conversions/include;/usr/include/eigen3;/opt/ros/kinetic/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'eigen_conversions' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/nvidia/catkin_ws_/src/geometry/eigen_conversions/${idir}'.  ${_report}")
    endif()
